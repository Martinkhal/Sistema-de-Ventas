...
namespace CapaLogicaNegocio
{
    public class clsProducto
    {
        ...
        private Int32 m_StockMinimo; //CDA05
        ...
        public Int32 StockMinimo //CDA05
        {
        ...
        {
            return M.Listado("ListadoProductosStockBajo", null);
        }
        ...
        public String RegistrarProductos()
        {
            ...
            try
            {
                ...
                lst.Add(new clsParametro("@StockMinimo", m_StockMinimo)); //CDA05
